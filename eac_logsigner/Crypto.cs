...
public static class Crypto
{
    ...
    public static readonly int[] S = new int[256];
    public static readonly int[] Si = new int[256];
    ...
    public static readonly uint[] T4 = new uint[256];
    public static readonly uint[] T5 = new uint[256];
    public static readonly uint[] T6 = new uint[256];
    public static readonly uint[] T7 = new uint[256];
    public static readonly uint[] T8 = new uint[256];
    public static readonly uint[] U1 = new uint[256];
    public static readonly uint[] U2 = new uint[256];
    public static readonly uint[] U3 = new uint[256];
    public static readonly uint[] U4 = new uint[256];

    public static readonly int[] rcon = new int[30];
